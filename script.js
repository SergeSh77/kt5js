...
function swithBank(){
    switch (selectBank.value) {
        case 'СБЕР':
            ...
            logo.src = 'https://vshkole.net/img/sberbank.37e3f09b.png'
            return 'https://vshkole.net/img/sberbank.37e3f09b.png'
            break
        case 'Тинькофф':
...
function switchSystem(){
    switch (selectSystem.value) {
        case 'VISA':
            system.src = 'https://www.3dfleur.ru/wp-content/uploads/2019/11/visa_logo_norm.png'
            return 'https://www.3dfleur.ru/wp-content/uploads/2019/11/visa_logo_norm.png'
            break
        case 'MASTERCARD':
